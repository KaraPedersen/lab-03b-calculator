...
const subtractInput1 = document.getElementById('subtraction-input-1');
const subtractInput2 = document.getElementById('subtraction-input-2');
const subtractAnswer = document.getElementById('subtraction-answer');
...
const divideInput1 = document.getElementById('division-input-1');
const divideInput2 = document.getElementById('division-input-2'); 
const divideAnswer = document.getElementById('division-answer')
